...
export default function PhotoUploader({
  ...
  async function uploadPhoto(e) {
    ...
    if (id) {
      ...
      const { data } = await axios.post("/places/upload-photos", formData);
      setAddedPhotos(data.data);
    }
  }
  ...
  async function uploadCoverImage(e) {
    ...
    coverImageFormData.append("coverImage", file);
    const { data } = await axios.post(
      "/places/upload-cover-image",
      coverImageFormData
    );
              ...
              <div className="h-42 w-full  flex relative " key={index}>
                ...
                {id && (
                  <>
                    ...
                    <button
                      onClick={(e) =>
                        changeCoverImage(e, index, coverImage, photo)
                      }
